...
We will follow the study program from [Trybe](https://app.betrybe.com/learn)

1. Before each lesson: Student reads the material of that lesson (link on the lesson description)
2. Lesson
3. After lesson the student does the exercises or projects
